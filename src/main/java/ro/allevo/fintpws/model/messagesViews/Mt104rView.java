...
/**
 * @author remus
 * @version $Revision: 1.0 $ The persistent class for the MT104RVIEW database
 *          view.
 */
@Entity
public class Mt104rView extends MtView implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = -2053365392074482791L;
