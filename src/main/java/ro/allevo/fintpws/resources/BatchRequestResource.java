...
public class BatchRequestResource {
	 ...
	 * Field logger.
	 */
	private static Logger logger = LogManager.getLogger(BatchRequestResource.class);

	/**
	 * Field ERROR_MESSAGE_GET_BATCH_REQUEST. (value is ""Error returning batch request : "")
	 */
	static final String ERROR_MESSAGE_GET_BATCH_REQUEST = "Error returning batch request : ";
	/**
	 * Field ERROR_MESSAGE_PUT_BATCH_REQUEST . (value is ""Error updating batch request : "")
	 */
	static final String ERROR_MESSAGE_PUT_BATCH_REQUEST = "Error updating batch request : ";
	/**
	 * Field ERROR_MESSAGE_BR_NOT_FOUND. (value is ""Batch request with name [%s] not
	 * found"")
	 */
	...
	public static List<BatchRequestEntity> findByGroupKey(
		...
		List<BatchRequestEntity> batchRequestEntities =  query
				.setParameter("key", groupKey).getResultList();
	...
	public Response getBatchRequest(){
		try {
			...
			throw new ApplicationJsonException(e, ERROR_MESSAGE_GET_BATCH_REQUEST
					+ ERROR_REASON_JSON,
